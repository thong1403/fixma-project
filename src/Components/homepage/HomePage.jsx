    ...
    <div className="homePage-container">
        ...
        <div className="detail">
          <div className="real-estate">
            ...
            <p>
              ...
              nhà đất ở địa thế vàng - Trái tim của Châu Âu, vừa mang lại cho cả
              3 thế hệ gia đình những đặc quyền vô giá của một công dân toàn
              cầu.
            </p>
      ...
      <div className="container-content-home">
        <div className="content-container-button">
          ...
          <p className="register-now">Đăng ký ngay <i class="fa-solid fa-arrow-right"></i></p>
        </div>
      </div>
    </div>
  );
